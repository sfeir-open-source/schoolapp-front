...
interface CatalogueDetailsImageProps {
  src: string;
  alt: string;
}

export default function CatalogueDetailsImage({ src, alt }: CatalogueDetailsImageProps) {
  ...
  return (
    <div className='relative'>
      {loading && (
        <div className='absolute flex h-40 w-full items-center justify-center  bg-gray-300 dark:bg-gray-700'>
          <svg
